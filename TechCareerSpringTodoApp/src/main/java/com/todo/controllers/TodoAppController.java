...
@Controller
public class TodoAppController implements ITodoAppController {
	...
	public String index(Model model) {
		...
		model.addAttribute("items", new TodoList(todoList));
